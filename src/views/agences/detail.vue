      ...
      <a-col :span="24" :md="16" class="mb-24">
        ...
        >
          <div class="text-right mb-4">
            ...
            >
            <router-link
              :to="{ name: 'Agence_carnet_detail', params: { id: agence.id } }"
              ><a-button type="primary" class="mx-2"
                >Affectation carnets</a-button
              ></router-link
            >
            <router-link
              :to="{ name: 'Agence_client_detail', params: { id: agence.id } }"
              ><a-button type="primary" class="mx-2"
                >Client inactif</a-button
              ></router-link
            >
...
export default {
  ...
  methods: {
    ...
    listeCarnetAffecter() {
      ...
      this.$http
        .post(
          `${this.callback}/v3-upgrade/agency_pack/list/${this.$route.params.id}`,
          {},
          headers
        )
        .then(
