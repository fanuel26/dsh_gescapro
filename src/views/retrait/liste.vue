        ...
        <a-card class="card card-body border-0">
          <template #title>
            <div class="mb-4 d-flex justify-content-between align-items-center">
              <h6>Liste des demande de retrait</h6>
            ...
            <a-modal
              :visible="visible"
              title="Total retrait par période"
              @ok="handleOk"
              @cancel="handleCancel"
            >
              <a-row :gutter="24">
                <a-col :span="24" :lg="24" :xl="24" class="mb-4">
                  <a-date-picker
                    :value="date"
                ...
                <!-- <a-col :span="12" :lg="12" :xl="12" class="mb-4">
                  <a-date-picker
                    :value="date"
                    picker="month"
                    @change="changeValueMonth"
                    style="width: 100%"
                  />
                </a-col> -->
                <a-col
          ...
          <a-table :columns="columns" :data-source="data">
            <template slot="operation" slot-scope="text, record">
              <div class="d-flex">
                <a-popconfirm v-if="record.state == 0 || record.state == null"
                ...
                <a-popconfirm v-if="record.state == 1 || record.state == null"
          ...
          (response) => {
            ...
            for (let i = 0; i < data.length; i++) {
              this.data.push({
                ...
                state: data[i].state,
                etat: data[i].state == 1 ? "Accepter" : data[i].state == 0 ? "Rejeter" : "",
              });
